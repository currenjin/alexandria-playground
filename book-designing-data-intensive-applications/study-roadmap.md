...
실습 우선 순서: [DDIA Hands-on Lab](./labs/README.md)을 따른다.

```text
Ch.3 저장소 -> Ch.7 트랜잭션 -> Ch.5 복제 -> Ch.6 파티셔닝
-> Ch.8 장애 -> Ch.9 합의/락 -> Ch.4 스키마 -> Ch.10~12 파생 데이터
```

이 순서는 손에 잡히는 저장소/락/트랜잭션을 먼저 구현한 뒤, 복제/파티셔닝/합의가 왜 필요한지 이해하기 위한 순서다.
