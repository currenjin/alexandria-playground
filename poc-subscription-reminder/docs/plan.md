...
- [ ] 결제 주기 3종에 대해 nextBillingDate 계산이 정확히 동작한다.
- [ ] 월말/윤년 보정 규칙이 테스트로 검증된다.
- [ ] dDay 오프셋 규칙에 맞는 리마인더만 생성된다.
- [ ] 메시지 템플릿이 amount 유무에 따라 자연스럽게 출력된다.
- [ ] 핵심 로직은 테스트로 보호된다(최소 15개 케이스).
- [ ] 데모 실행 방법이 문서화되어 있다.
...
## 8. 테스트 케이스(초안 15개)
### Monthly
- [ ] first=2026-01-15, today=2026-01-10 -> next=2026-01-15
- [ ] first=2026-01-15, today=2026-01-15 -> next=2026-01-15
- [ ] first=2026-01-15, today=2026-01-16 -> next=2026-02-15
- [ ] first=2026-01-31, today=2026-02-01 -> next=2026-02-28 (월말 보정)
- [ ] first=2026-01-31, today=2026-03-01 -> next=2026-03-31

### Yearly
- [ ] first=2020-06-10, today=2026-01-10 -> next=2026-06-10
- [ ] first=2020-06-10, today=2026-06-10 -> next=2026-06-10
- [ ] first=2020-06-10, today=2026-06-11 -> next=2027-06-10
- [ ] first=2024-02-29, today=2026-01-10 -> next=2026-02-28 (윤년 보정)
- [ ] first=2024-02-29, today=2028-02-28 -> next=2028-02-29 (윤년 복귀)

### Every N Days
- [ ] first=2026-01-01, n=30, today=2026-01-10 -> next=2026-01-31
- [ ] first=2026-01-01, n=30, today=2026-01-31 -> next=2026-01-31
- [ ] first=2026-01-01, n=30, today=2026-02-01 -> next=2026-03-02

### Reminder extraction
- [ ] due=today+3, offsets=[7,3,1,0] -> D-3 리마인더 생성
- [ ] due=today+2, offsets=[7,3,1,0] -> 리마인더 생성 안 됨
